# tf.contrib.learn is a high-level TensorFlow library 
# that simplifies the mechanics of machine learning, including the following:
...
# Notice how our eval data has a higher loss, 
# but it is still close to zero. That means we are learning properly.
